...
func New(cfg config.Config) (*Service, error) {
	...
	service := &Service{
		...
		snapshot: Snapshot{
			...
			InterfaceOptions: InterfaceOptions{EnableTestfield: cfg.InterfaceDefaults.EnableTestfield, Testfield: cfg.InterfaceDefaults.Testfield, BallTracked: cfg.InterfaceDefaults.BallTracked, GCData: cfg.InterfaceDefaults.GCData},
